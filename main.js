...
const worksData = {
  ...
  'kas-club': {
    ...
    images: [
      ...
      'images/cosplay/club-more-1.jpg',
      'images/cosplay/club-more-2.jpg',
      'images/cosplay/club-more-3.jpg',
      'images/cosplay/club-more-4.jpg',
      'images/cosplay/club-more-5.jpg',
  ...
  'blue-tongue': {
    ...
    description: '青い舌 portrays a figure drawn from トー横キッズ (Toyoko Kids): the runaway and marginalized teenagers who gather in the alleys beside the former Toho cinema building (トー横) in Shinjuku\'s Kabukicho.<br><br>The title points to a real marker within that world. Since July 2015, every flunitrazepam sleeping pill sold in Japan (ロヒプノール / サイレース) has been dyed with 青色1号 (Blue No. 1) as an abuse deterrent: crushed or held in the mouth, the tablet turns vivid blue and stains the tongue. Among トー横キッズ, the 「青い舌」 became a quiet, visible sign of オーバードーズ (overdose), a mark of belonging to a group bound by the same escape.<br><br>The figure is rendered in 地雷系 (jirai-kei) and 病みかわいい (yamikawaii): twin tails, a spiralled red eye, hair-clip X marks, a sailor collar, the blue tongue held forward almost as an offering. The aesthetic performs cuteness while carrying self-harm beneath it. The work sits with that contradiction rather than resolving it, refusing to romanticize the subculture or reduce these teenagers to a warning.',
  ...
  'next-big-thing': {
    ...
    meta: 'Business Club · Grades 10–11 · Poster',
    description: '',
    thumbs: false,
    images: [
      'images/design/next-big-thing-1.jpg'
    ]
  },
  'cosplay-posters': {
    title: 'Cosplay Club',
  ...
  'noctilucent': {
    ...
    description: 'Noctilucent takes its name from the rarest atmospheric phenomenon: clouds that carry no light of their own, visible only when lit from below the horizon, shining in a darkness they did not create. Like them, this work generates no light of its own; it needs the right conditions to become visible at all.<br><br>The diptych grew from the experience of rarely opening up. The complex, often unnamed emotions of adolescent girlhood leave only faint traces on the surface, but with the right person, or under the right conditions, everything held inside comes out at once. Switching on the UV light enacts this literally: a threshold crossed not gradually, but all at once.<br><br>Where Behind the Pink conceals through a composed exterior and Penumbra through private solitude, Noctilucent abandons the figure entirely, letting color and material process carry the psychological weight. Two fluid acrylic canvases, made with fluorescent paint, mod podge, and silicone oil, sit suppressed under normal light. Under UV, the black canvas reads as cosmic and explosive, the white as cellular, its surface suggesting nerve endings and internal structures pushed outward.<br><br>The cellular forms emerge from the chemical resistance between silicone oil and water-based paint: where they meet they push apart, and that refusal becomes form. The process is half directed, half uncontrollable. It draws on the unpredictability of Damien Hirst\'s Spin Paintings and his scientific imagery, and like Kenny Scharf\'s Cosmic Cavern, what is suppressed under ordinary light becomes overwhelming the moment UV is introduced.',
    images: [
  ...
  'penumbra': {
    ...
    description: 'Penumbra takes its title from the region of partial shadow at the edge of total darkness: not fully concealed, not fully visible, caught in between. Where Behind the Pink examined concealment performed for others, Penumbra moves inward. The figure is no longer performing for an audience; she is alone in a midnight bedroom where social pressure dissolves and the mind turns over itself: each possible decision, each unresolved identity, each future self coexisting without resolution.<br><br>A single figure inhabits a pitch black ground of burnished oil pastel dissolved with linseed oil, its density enacting the weight of the night. A diffuse pink halo reads both as a residue of innocence and as an unwanted spotlight: even alone, she remains seen. Her neon body, built from layered oil pastel and fluorescent acrylic dripped downward with pouring medium, gives each color a distinct, simultaneous unresolved self occupying the same form.<br><br>Modelling paste beneath the drips raises the forms off the surface, the texture enacting thoughts that overflow and consume the figure. The box frame seals her inside, referencing Hsu Shu Han\'s framing of the girl under the gaze, while the resin surface and vibrant palette carry the seductive pull of Damien Hirst.<br><br>Under UV light the work activates completely: what seemed contained is revealed in full intensity, the surface finally showing what the figure has been holding.',
    images: [
  ...
  'obsidian': {
    ...
    meta: 'Lee, Chloe. <em>Obsidian and Prismatic Light</em>. 2025. Charcoal Transfer Monoprint, Watercolor, Colored Pencil. 21 × 29.7 cm.',
    description: 'A cityscape built through charcoal transfer monoprint, its structures dense and grainy, pressed into the paper with the weight of obsidian. Beneath and around them, watercolor washes in pink, teal, purple, and yellow bleed outward, prismatic and uncontained by the architecture above.<br><br>A large spider sits across the right side of the composition, its web threading between buildings. The web does not feel threatening so much as structural: another kind of architecture, lighter and more precise than the city beneath it.<br><br>The piece holds two opposing qualities at once. The charcoal is fixed, heavy, transferring darkness directly. The watercolor is loose, luminous, moving where it wants. Between them, the image finds its tension.',
    images: ['images/art/obsidian-1.jpg']
  },
  'kabukicho-street': {
    title: '歌舞伎町',
    meta: 'Lee, Chloe. <em>歌舞伎町</em>. 2025. Colored Pencil, Marker, Fineliner. 29.7 × 42 cm.',
    description: 'A two-panel observational drawing of Kabukicho, Shinjuku, spread across an A3 sheet. The left panel looks down the street toward the I Love Kabukicho building; the right frames the iconic red gate of 歌舞伎町一番街. In both panels, the architecture is rendered in full color while the crowds below are left in graphite grey, anonymous and interchangeable against the vivid signage above them.<br><br>The contrast was not planned so much as noticed: the city announces itself loudly, the people passing through it less so.',
  ...
  'petri-resin': {
    ...
    description: 'A circular resin disc flooded with alcohol ink, held to the window so light passes straight through. The colors bloom from a dense core into feathered spikes of magenta, red, blue, and green, more specimen than painting.<br><br>The form is inspired by the petri dish: a contained circular field where something is left to spread, react, and grow on its own terms. I was also drawing on the textural, geological surfaces of Dylan Gebbia-Richards, not copying his method but recreating a similar sense of organic accumulation in a different medium, letting the ink move through the resin so the texture forms itself instead of being drawn.<br><br>Still in progress. I am testing how the ink behaves as it cures and how the disc reads under different light.',
